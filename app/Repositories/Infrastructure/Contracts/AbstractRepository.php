...
abstract class AbstractRepository implements RepositoryInterface
{
     ...
     * @return mixed
     */
    public function all(array $columns = [RepositoryInterface::DEFAULT_COLUMNS])
    {
     ...
     * @return mixed
     */
    public function paginate($perPage = 15, array $columns = [RepositoryInterface::DEFAULT_COLUMNS])
    {
     ...
     * @return mixed
     */
    public function find($id, array $columns = [RepositoryInterface::DEFAULT_COLUMNS])
    {
     ...
     * @return mixed
     */
    public function findBy($field, $value, array $columns = [RepositoryInterface::DEFAULT_COLUMNS])
    {
